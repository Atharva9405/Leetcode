...
The above output is its valid prefix form.<br><br></span><div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>
...
+ab
<strong>Explanation:</strong> 
The above output is its valid prefix form.<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>
